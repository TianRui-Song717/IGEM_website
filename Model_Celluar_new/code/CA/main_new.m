...
% Distribution
D = 5; % Interval cell number (diatance=25m)
...
figure (4)
imagesc(map_now_alt)
title('Distribution of Earthworms','FontSize',20)
colorbar
grid on;
set(gca, 'XTick', 0:1:100,'FontSize',4);
set(gca, 'YTick', 0:1:100,'FontSize',4);
...
title('The percentage of lead treated ')
colorbar
grid on;
set(gca, 'XTick', 0:1:100,'FontSize',7);
set(gca, 'YTick', 0:1:100,'FontSize',7);
