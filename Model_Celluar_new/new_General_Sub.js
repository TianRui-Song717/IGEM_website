$(function(){
  $(window).scroll(function(){
    ...
    var element_7 = $("#general_info_ele_7").offset().top;
    var element_8 = $("#general_info_ele_8").offset().top;
    ...
    if(curTop >= (element_5 - 10) && curTop < (element_6 - 10)){
      $("#sidenav_5").addClass("general_side_nav_color");
    }else{
      $("#sidenav_5").removeClass("general_side_nav_color");
    }
    if(curTop >= (element_6 - 10) && curTop < (element_7 - 10)){
      $("#sidenav_6").addClass("general_side_nav_color");
    }else{
      $("#sidenav_6").removeClass("general_side_nav_color");
    }
    if(curTop >= (element_7 - 10) && curTop < (element_8 -500)){
      $("#sidenav_7").addClass("general_side_nav_color");
    }else{
      $("#sidenav_7").removeClass("general_side_nav_color");
    }
    if(curTop >= (element_8 - 500)){
      $("#sidenav_8").addClass("general_side_nav_color");
    }else{
      $("#sidenav_8").removeClass("general_side_nav_color");
    }
    // alert("改成红色！！！");
  })
})
...
$(function(){
  $(".general_sidenav_a").click(function(){
    ...
    }else if($(this).attr("id") == "sidenav_7"){
      $("html,body").animate({scrollTop:element_7},1000);
    }else if($(this).attr("id") == "sidenav_8"){
      $("html,body").animate({scrollTop:element_8},1000);
    }
  })
})
