...
$(function(){
  $(".general_sidenav_a").click(function(){
    ...
    if($(this).attr("id") == "sidenav_1"){
      $("html,body").animate({scrollTop:element_1},600);
    }else if($(this).attr("id") == "sidenav_2"){
      $("html,body").animate({scrollTop:element_2},600);
    }else if($(this).attr("id") == "sidenav_3"){
      $("html,body").animate({scrollTop:element_3},600);
    }else if($(this).attr("id") == "sidenav_4"){
      $("html,body").animate({scrollTop:element_4},600);
    }else if($(this).attr("id") == "sidenav_5"){
      $("html,body").animate({scrollTop:element_5},600);
    }
  })
})
